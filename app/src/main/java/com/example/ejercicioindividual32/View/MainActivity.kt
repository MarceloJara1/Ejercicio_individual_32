...
import com.example.ejercicioindividual32.databinding.ActivityMainBinding
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        return when (item.itemId) {
            R.id.action_settings -> {
                ...
                Snackbar.make(binding.root, "Se eliminaron todos los datos...", Snackbar.LENGTH_SHORT).show()
                true
